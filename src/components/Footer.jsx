...
const Footer = () => {
    return (
        <div>
            <div className="w-full bg-orange-200 bg-opacity-60 min-h-[250px] pt-5">
                <footer className="footer container mx-auto p-10 text-base-content flex flex-col md:flex-row justify-between items-start dark:text-white">
                    <aside>
                        <div className="shadow-lg p-2 rounded">
                            <Link to='/'>
                                <h1 className="text-3xl font-medium">Golam Kibria</h1>
                            </Link>
                        </div>
                        <p className=""><span className="font-medium text-base">Junior MERN Stack Developer</span> <br />At Your Service</p>
                    </aside>
                    <nav>
                        <header className="footer-title">Contact Information</header>
                        <p><span className="font-semibold">Address - </span> Modhumoti 6/B, RUAP, Uttara-18, Dhaka, Bangladesh</p>
                        <p><span className="font-semibold">Phone - </span> +880 1305 034 369</p>
                        <p><span className="font-semibold">Email - </span> uchihai850@gmail.com</p>
                        <p><span className="font-semibold">Website - </span><a href="">www.kibria.com</a></p>
                    </nav>
                    <nav>
            ...
            <aside className="text-center py-3 bg-orange-400 bg-opacity-60 text-black">
                <p className="text-xs md:text-sm font-normal">Copyright © 2023 - All right reserved by <span className="font-medium text-base">Golam Kibria</span></p>
            </aside>
        </div>
    );
};
